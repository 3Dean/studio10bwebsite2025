...
description: "A behind-the-scenes look at the navigation experiments, Blender production, Three.js architecture, accessibility decisions, cinematic systems, and commerce behind Painted Paths."
...
<ProcessTimeline
  items={[
    ...
    {
      date: 'July 28',
      title: 'Analytics and a cinematic camera language',
      description: 'Privacy-conscious measurement arrived across all three entry points alongside manual, idle, and deterministic capture versions of a composed gallery tour.'
    },
    {
      date: 'August 3–5',
      title: 'Richer artwork stories and camera continuity',
      description: 'Photo and video galleries, an interactive lit merchandise model, a hallway bridge, technical render modes, and a final authored camera target refined the experience.'
    }
  ]}
/>
...
## Giving the gallery a cinematic camera language
...
<ProcessCallout title="Cinematic principle">
  The cinematic camera borrows the gallery's authored spatial language, but it remains separate from visitor navigation so presentation never destroys the view a visitor chose.
</ProcessCallout>
